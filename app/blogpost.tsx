...
const BlogPost: React.FC<BlogPostProps> = ({ imageUrl }) => {
  return ( 
    <div className="bg-white relative lg:w-2/3 w-4/5 mx-auto my-16">
        <img
          src={imageUrl}
          alt="Personal Growth"
          className="xl:w-1/2 md:2/3 w-4/5 object-cover"
        />
