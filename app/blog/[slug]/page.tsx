...
import { fetchPostBySlug } from "@/lib/contentful/fetchposts";
      ...
      <div className="container mx-auto w-4/5 px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="mb-8">
              <p>
                This post may contain affiliate links. This means that if you
                click a link and purchase a product or service we recommend, we
            ...
            />
            <div>
              <h3 className="text-xl text-rose-400 mb-4 text-center">
                {post.fields.category}
              </h3>
              <h1 className="text-4xl mb-4 text-center">{post.fields.title}</h1>
              <h3 className="text-base text-rose-400 mb-4 text-center">
                {formattedDate}
              </h3>
              ...
              <div className="bg-white w-full h-auto py-8 flex items-center justify-center gap-4 flex-wrap">
                ...
                <button className="group transition-all duration-500 hover:-translate-y-2">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M44.2808 23.0437C36.8492 23.893 29.4439 30.0479 29.1382 38.84C28.9461 44.2083 30.435 48.2356 35.4258 49.3664C37.5915 45.4553 34.7272 44.5927 34.2818 41.7633C32.4523 30.1686 47.346 22.2615 55.14 30.3563C60.5324 35.9615 56.9826 53.206 48.2848 51.4136C39.9537 49.7017 52.3629 35.9749 45.713 33.2796C40.3074 31.0894 37.4343 39.9798 39.9974 44.396C38.4953 51.9902 35.2599 59.1464 36.5698 68.6715C40.8183 65.5158 42.2504 59.4727 43.425 53.1702C45.5601 54.4978 46.6998 55.8789 49.4244 56.0935C59.4714 56.8891 65.0822 45.8263 63.7112 35.6218C62.4929 26.5749 53.6729 21.971 44.2808 23.0437Z"
                      fill="white"
                    />
                  </svg>
                </button>
              ...
              <div className="[&>p]:mb-8 [&>h2]:font-extrabold">
                {documentToReactComponents(post.fields.mainBody)}
              </div>
            </div>
          ...
          <div>
            <div className="flex flex-col items-center">
              <img
                src="https://www.sundayrainday.com/wp-content/uploads/2023/07/Styled-Stock-Society-Summer-Weekend-23-scaled.jpg"
                alt="Author"
              ...
              <div className="text-center">
                ...
                <p>
                  I am a 30-year-old obsessed with Productivity and Personal
                  Growth. I help young, ambitious women increase their
                  productivity and design a life they love.
                </p>
              </div>
            </div>
            <div className="bg-rose-100 p-6 text-center my-4 mb-8">
              ...
              <p className="mb-4">
                Join +5,000 weekly readers and unlock the Free Library
              </p>
